...
//solution
let bind = (func, context, ...outer) =>
  (...inner) => func.apply(context, [...outer, ...inner]);

Function.prototype.bind = function (context, ...outer) {
  return (...inner) => this.apply(context, [...outer, ...inner])
  };
